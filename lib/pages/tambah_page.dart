...
class TambahPage extends StatefulWidget {
  ...
  const TambahPage({super.key, required this.onSave});
  @override
...
class _TambahPageState extends State<TambahPage> {
  ...
  Future<void> _simpan() async {
    ...
    try {
      ...
      final saved = await SupabaseService.tambahProduk(p);
      widget.onSave(saved);
      if (mounted) {
        _snack('Produk berhasil ditambahkan');
        Navigator.pop(context);
      }
    } catch (e) {
            ...
            Container(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: (_loading || _uploadingImage) ? null : _simpan,
                  child: _loading
                      ? const SizedBox(
                          width: 20,
                          height: 20,
